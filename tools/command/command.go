...
func DockerCommand(image string, checksum string, distroName string, outputDir string, packages []string) (string, []string, error) {
	var cmd = "docker"
	var args = []string{
		"run",
		"--privileged",
	...
	args = append(args, image, checksum, distroName, "/output")
